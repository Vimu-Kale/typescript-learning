    ...
    <div className="auth-container">
      {storeIsModalOpen && (
        <a
          ...
          href="https://github.com/Vimu-Kale/typescript-learning"
          target={"_blank"}
        >
          GitHub
        </a>
...
function LoginPage() {
  const [loginLength, setLoginLength] = React.useState<boolean>(false);
  const [isLoginValid, setIsLoginValid] = React.useState<boolean>(false);

  const [passLength, setPassLength] = React.useState<boolean>(false);
    ...
    <div>
      ...
      <form className="form-container" onSubmit={submitHandler}>
        ...
        <div className="form-error">
          {loginLength && <span>{t("formError.loginLength")}</span>}
        ...
        <div className="form-error">
          {passLength && <span>{t("formError.passLength")}</span>}
